...
Listt = hamming_array+[psi_tens]
List = [psi_tens] + [hamming_array]*N + [psi_tens]

#path_info1 = np.einsum(Co, *Listt, optimize = 'greedy')
#path_info2 = np.einsum(ein_command, *List, optimize = 'greedy')
